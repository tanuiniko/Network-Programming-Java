...
Meaning, client-1 opens and sends messages first, then client-2 opens and sends and now its perfectly possible for client-1 to send a message as the connection is always open and not closed. 
This justifies that udp sockets sends each datagram packets as an isolated transmission whenever necessary.
